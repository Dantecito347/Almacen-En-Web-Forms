...
-- CREACI�N DE TABLAS PARA LAS DISTINTAS FUNCIONALIDADES Y SUS DATOS
...
-- CREACI�N DE PROCEDIMIENTOS ALMACENADOS PARA LAS DISTINTAS FUNCIONALIDADES DE LA APP
...
BEGIN
    ...
    BEGIN
        ...
        ELSE
        BEGIN
            PRINT 'No se encontr� un repartidor con ese ID o Email.';
        END
    END
    ELSE
    BEGIN
